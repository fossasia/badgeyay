...
class SVG2PNG:
    ...
    def __init__(self):
        ...
        self.SVGS_FOLDER = os.path.join(self.APP_ROOT, 'static/svgs')
    ...
    def do_svg2png(self, filename, opacity, fill):
        """
        ...
        filename = os.path.join(self.SVGS_FOLDER, filename)
        ...
        print("done")
        svg2png(url=filename, write_to=self.UPLOAD_FOLDER + '/' + png_filename)
        print("Image Saved")
