...
class BadgeyayTest(unittest.TestCase):
    ...
    def test_png_upload(self):
        Imagepath = os.path.abspath(os.path.join(
            os.getcwd(), 'badges/badge_1.png'))
        CSVpath = os.path.abspath(os.path.join(
            os.getcwd(), 'sample/vip.png.csv'))
        self.driver.find_element_by_name("file").send_keys(CSVpath)
        ...
        success = self.driver.find_element_by_css_selector(".flash-success")
        self.assertIn(
            u'Your badges has been successfully generated!', success.text)
    ...
    def test_csv_upload(self):
        ...
        success = self.driver.find_element_by_css_selector(".flash-error")
        self.assertIn(
            u'Please upload an image in \'PNG\' format!', success.text)
