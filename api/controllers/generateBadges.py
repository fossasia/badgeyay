...
def generateBadges():
    ...
    badge_created = Badges(image=image_name, csv=csv_name,
                           ,font_color_1=font_color_1, font_color_2=font_color_2, font_color_3=font_color_3
                           ,font_color_4=font_color_4,font_color_5=font_color_5, badge_size=badge_size,
