...
export default Route.extend({
  ...
  setupController(controller, model) {
    ...
    let { badge } = model;
    let ticket_types = badge.ticket_types.split(',');
    controller.setProperties({
      ...
      'imageData'     : badge.image_link.split(','),
      'custImage'     : ticket_types.map(()=> true),
      'defImage'      : ticket_types.map(()=> false),
      'ticketTypes'   : ticket_types,
      'csvFile'       : badge.csv,
      'csvType'       : badge.csv_type,
      'mode'          : 'edit',
      ...
      'badgeGenerated'     : true,
      'badgeGeneratedLink' : badge.download_link
    });
